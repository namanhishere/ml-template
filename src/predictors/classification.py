...
IMAGENET_CLASSES = [
    ...
    "salamander", "newt", "axolotl", "bullfrog", "tree frog",
    "tailed frog", "loggerhead", "leatherback turtle", "mud turtle", "terrapin",
    "box turtle", "banded gecko", "common iguana", "chameleon", "gila monster",
    "whiptail", "agama", "frilled lizard", "alligator lizard", "slow worm",
    "snake", "grass snake", "water snake", "vine snake", "night snake",
    "boa", "rock python", "cobra", "mamba", "sea snake",
    "horned viper", "diamondback", "sidewinder", "trilobite", "harvestman",
    "scorpion", "spider", "tarantula", "wolf spider", "tick",
    ...
    "hummingbird", "jacamar", "toucan", "drake", "merganser",
    ...
    "slug", "sea slug", "chiton", "nautilus", "dungeness crab",
    "rock crab", "fiddler crab", "king crab", "lobster", "spiny lobster",
    "crayfish", "hermit crab", "isopod", "white stork", "black stork",
    "spoonbill", "flamingo", "little blue heron", "egret", "bittern",
    "crane", "bustard", "ruddy turnstone", "redshank", "dowitcher",
    "oystercatcher", "pelican", "king penguin", "albatross", "grey whale",
    "killer whale", "dugong", "sea lion", "chihuahua", "japanese spaniel",
    "maltese", "pekinese", "shih-tzu", "king charles spaniel", "papillon",
    ...
    "weimaraner", "staffordshire bullterrier", "staffordshire terrier", "bedlington terrier", "border terrier",
    ...
    "mexican hairless", "timber wolf", "white wolf", "coyote", "dingo",
    ...
    "otter", "skunk", "badger", "armadillo", "sloth",
    "orangutan", "gorilla", "chimpanzee", "gibbon", "siamang",
    "proboscis monkey", "macaque", "patas", "baboon", "mandrill",
    "colobus", "langur", "proboscis monkey", "indri", "howler monkey",
    "marmoset", "white-headed capuchin", "spider monkey", "squirrel monkey", "moustached tamarin",
    "emperor tamarin", "titi", "saki", "uakari", "mouse",
    "hamster", "rat", "guinea pig", "chipmunk", "prairie dog",
    "bison", "ox", "wildebeest", "hartebeest", "topi",
    "gazelle", "springbok", "blackbuck", "impala", "dik-dik",
    "klipspringer", "duiker", "steenbok", "sable antelope", "oryx",
    "waterbuck", "kudu", "eland", "nilgai", "four-horned antelope",
    "takin", "musk ox", "pronghorn", "giraffe", "okapi",
    "eastern diamondback", "sidewinder", "horned viper", "cobra", "mamba",
    "green snake", "king snake", "garter snake", "water snake", "vine snake",
    "night snake", "indigo snake", "boomslang", "file snake", "trilobite",
    ...
    "flamingo", "little blue heron", "great egret", "bittern", "crane bird",
    ...
    "white wolf", "coyote", "dingo", "dhole", "african hunting dog",
    "hyena", "red fox", "kit fox", "arctic fox", "grey fox",
    "tabby", "tiger cat", "persian cat", "siamese cat", "egyptian mau",
    ...
    "water buffalo", "bison", "ram", "bighorn", "ibex",
    ...
    "spider monkey", "squirrel monkey", "madagascar cat", "indri", "woolly monkey",
    "mongoose lemur", "dwarf lemur", "aye-aye", "ring-tailed lemur", "sifaka",
    "indri", "tarsier", "marmoset", "tamarin", "spider monkey",
    "howler monkey", "squirrel monkey", "capuchin", "titi monkey", "saki monkey",
    "uakari", "night monkey", "woolly monkey", "spider monkey", "marmoset",
    "tamarin", "titi", "saki", "uakari", "proboscis monkey",
    "gibbon", "siamang", "orangutan", "gorilla", "chimpanzee",
    "bonobo", "human", "neanderthal", "homo erectus", "australopithecus",
]
...
class ClassificationPredictor(BasePredictor):
    def __init__(
        ...
        if class_names is not None:
            ...
            self.class_names = (
                ...
                or ckpt.get("config", {}).get("class_names")
                or IMAGENET_CLASSES
            )
        else:
    ...
    def postprocess(self, outputs: dict[str, Any]) -> dict[str, Any]:
        ...
        top_class_name = (
            self.class_names[top_class_idx]
